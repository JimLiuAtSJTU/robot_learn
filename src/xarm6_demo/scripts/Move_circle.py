...
class MoveItCircleDemo:
	...
	target_pose.pose = arm.get_current_pose(end_effector_link).pose
	rospy.loginfo(str(target_pose.pose))                                     
        ...
        for th in numpy.arange(0, 6.28, 0.02):
            ...
            #print('%f, %f' % (target_pose.pose.position.y, target_pose.pose.position.z))
