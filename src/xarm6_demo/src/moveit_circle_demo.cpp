...
int main(int argc, char **argv)
{
    ...
    joint_group_positions[0] = 47.2/180.0*M_PI;
    joint_group_positions[1] = 32.2/180.0*M_PI;
    joint_group_positions[2] = -95.2/180.0*M_PI;
    joint_group_positions[3] = 0.0/180.0*M_PI;
    joint_group_positions[4] = 62.9/180.0*M_PI;
    joint_group_positions[5] = 47.2/180.0*M_PI;
    ...
    double radius = 0.2202471;

    for(double th=1.2; th>0.0762; th=th-0.01)
    {
