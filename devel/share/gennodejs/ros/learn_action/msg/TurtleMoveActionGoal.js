...
class TurtleMoveActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TurtleMoveGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TurtleMoveActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = TurtleMoveGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new TurtleMoveGoal()
    }
...
module.exports = TurtleMoveActionGoal;
