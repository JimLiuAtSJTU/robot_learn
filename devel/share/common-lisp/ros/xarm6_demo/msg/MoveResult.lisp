...
(cl:defmethod cl:initialize-instance :after ((m <MoveResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xarm6_demo-msg:<MoveResult> is deprecated: use xarm6_demo-msg:MoveResult instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <MoveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xarm6_demo-msg:success-val is deprecated.  Use xarm6_demo-msg:success instead.")
  (success m))

(cl:ensure-generic-function 'err_code-val :lambda-list '(m))
(cl:defmethod err_code-val ((m <MoveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xarm6_demo-msg:err_code-val is deprecated.  Use xarm6_demo-msg:err_code instead.")
  (err_code m))
