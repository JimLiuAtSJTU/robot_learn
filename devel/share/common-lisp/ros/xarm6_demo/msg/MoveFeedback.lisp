...
(cl:defmethod cl:initialize-instance :after ((m <MoveFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xarm6_demo-msg:<MoveFeedback> is deprecated: use xarm6_demo-msg:MoveFeedback instead.")))

(cl:ensure-generic-function 'current_pulse-val :lambda-list '(m))
(cl:defmethod current_pulse-val ((m <MoveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xarm6_demo-msg:current_pulse-val is deprecated.  Use xarm6_demo-msg:current_pulse instead.")
  (current_pulse m))
