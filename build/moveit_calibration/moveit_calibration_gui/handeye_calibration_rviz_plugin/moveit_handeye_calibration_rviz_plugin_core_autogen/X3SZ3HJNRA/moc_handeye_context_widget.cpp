...
QT_MOC_LITERAL(24, 313, 18), // "fovOnOffBtnToggled"
QT_MOC_LITERAL(25, 332, 7) // "checked"
    ...
    "value\0fovOnOffBtnToggled\0checked"
};
#undef QT_MOC_LITERAL
...
static const uint qt_meta_data_moveit_rviz_plugin__ContextTabWidget[] = {
 ...
 // slots: name, argc, parameters, tag, flags
      ...
      13,    6,   71,    2, 0x0a /* Public */,
      20,    1,   84,    2, 0x08 /* Private */,
      21,    1,   87,    2, 0x08 /* Private */,
      22,    1,   90,    2, 0x08 /* Private */,
...
void moveit_rviz_plugin::ContextTabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->fovOnOffBtnToggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
